...
void Сluster::addPoints(const std::vector<coordinates>& _points)
{
	points.insert(points.end(), _points.begin(), _points.end());
	calcCenter();
}
std::vector<coordinates>& Сluster::getPoints()
{
	return points;
}
Сluster::operator coordinates()
{
	return this->center;
}
...
std::vector<Сluster> clusterAnalysis::getClusters()
{
	return clusters;
}
